...
def addFolder():
    ...
    print(folderName)
    dirShow.configure(text = folderName)
...
openFile.pack()
dirShow =tk.Label(frame, text="Choose a foder",bg="#B1B1B1")
dirShow.pack()
runApp =tk.Button(frame, text="Run App", state='disabled', bg="#C6C6C6", fg = "black", activebackground="#32FF75", command = execute)
runApp.pack()
Reverse =tk.Button(frame, text="Reverse", state='disabled', bg="#C6C6C6", fg = "black", activebackground="#32FF75", command = rev)
Reverse.pack()
